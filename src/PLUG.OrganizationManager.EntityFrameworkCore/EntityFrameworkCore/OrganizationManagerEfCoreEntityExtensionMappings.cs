...
public static class OrganizationManagerEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE OrganizationManagerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
