...
namespace PLUG.OrganizationManager.Blazor.Menus;

public class OrganizationManagerMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public OrganizationManagerMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<OrganizationManagerResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                OrganizationManagerMenus.Home,
                l["Menu:Home"],
                "/",
                icon: "fas fa-home",
                order: 0
